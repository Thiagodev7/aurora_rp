...
emP = Tunnel.getInterface("emp_paramedico_skips")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = nil
...
local CoordenadaX = -441.48
local CoordenadaY = -318.54
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if distance <= 50.0 and IsVehicleModel(vehicle,GetHashKey("20ramambo")) then
				skips = 1
