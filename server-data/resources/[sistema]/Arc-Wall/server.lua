...
function arc.reportlinesLog(toggle)
	...
	if user_id then
        local imageurl = "https://media.discordapp.net/attachments/710563106522398802/930936001390596106/125x96.png"
        PerformHttpRequest(Config.webhooklines, function(err, text, headers) end, 'POST', json.encode({username = ' Tequila Anticheat - Sistema de ESP ', avatar_url = imageurl, embeds = {
                { 	------------------------------------------------------------
                    ...
                    footer = { 
                        ...
                        icon_url = "https://media.discordapp.net/attachments/710563106522398802/930936001390596106/125x96.png"
                    },
                    color = 3093194 
                }
            }
