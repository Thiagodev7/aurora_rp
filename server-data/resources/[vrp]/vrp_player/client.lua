...
function vehModels()
	local ped = GetPlayerPed(-1)
	local vehicle = GetVehiclePedIsIn(ped)
	return IsVehicleModel(vehicle,GetHashKey("sultanrs")) or IsVehicleModel(vehicle,GetHashKey("jeeppolicia")) or IsVehicleModel(vehicle,GetHashKey("mercxclass")) or IsVehicleModel(vehicle,GetHashKey("mercedespolicia")) or IsVehicleModel(vehicle,GetHashKey("m8comando")) or IsVehicleModel(vehicle,GetHashKey("r820p"))
end
