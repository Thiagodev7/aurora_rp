...
Citizen.CreateThread(function()
	while true do
		...
		SetDiscordAppId(1111733638413959279)
        ...
        SetDiscordRichPresenceAssetSmallText('discord.gg/kycJGdPXhw')

        SetDiscordRichPresenceAction(0, "Discord", "https://discord.gg/kycJGdPXhw")
        SetDiscordRichPresenceAction(1, "Jogar", "fivem://connect/191.96.78.31:30120")
