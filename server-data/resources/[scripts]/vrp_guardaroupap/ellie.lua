...
AddEventHandler("rpm1curta",function()
    ...
    if custom and vRP.hasPermission(user_id,"rpm.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
...
AddEventHandler("rpm2curta",function()
    ...
    if custom and vRP.hasPermission(user_id,"rpm1.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo")
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
...
AddEventHandler("got1curta",function()
	...
	if custom and vRP.hasPermission(user_id,"got.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo")
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
...
AddEventHandler("got2curta",function()
    ...
    if custom and vRP.hasPermission(user_id,"got1.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo") 
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
...
AddEventHandler("gtm",function()
    ...
    local user_id = vRP.getUserId(source)
    local custom = gtm
    if custom and vRP.hasPermission(user_id,"gtm.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo")
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
...
AddEventHandler("gsa1",function()
    ...
    local user_id = vRP.getUserId(source)
    local custom = gsa1
    if custom and vRP.hasPermission(user_id,"gsa.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo")
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
...
AddEventHandler("gic1",function()
    ...
    local user_id = vRP.getUserId(source)
    local custom = gic1
    if custom and vRP.hasPermission(user_id,"gic.permissao") or vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo")
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
...
AddEventHandler("comando",function()
    ...
    if custom and vRP.hasPermission(user_id,"cmdgeral.permissao") then
		TriggerClientEvent("progress",source,5000,"vestindo")
		vCLIENT.closeMenu(source)
		TriggerClientEvent('cancelando',source,true)
		vRPclient._playAnim(source,false,{{"clothingshirt","try_shirt_positive_d"}},true)
