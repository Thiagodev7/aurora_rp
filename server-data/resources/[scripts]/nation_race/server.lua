...
function func.checkReward(tempofinal,index)
	...
	if rank == 1 then
		vRP.giveInventoryItem(user_id,"dinheirosujo",reward * 1.10)
		TriggerClientEvent("Notify",source,"sucesso","Parabéns, você recebeu $ <b>"..vRP.format(reward * 1.10).."</b> sujo(s).", 5000)
	end
