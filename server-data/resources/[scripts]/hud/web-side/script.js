...
function setGas(gas){
    ...
    if (fill_gas > 77){
      ...
      fill_element.style.backgroundColor = '#42ad4b'
...
window.addEventListener('message', ({ data }) => {
    ...
    if (data.voice == '1') {
        ...
        voice_bars[1].style.background = '#42ad4b'
        ...
        voice_bars[2].style.background = '#42ad4b'
        ...
        voice_bars[3].style.background = '#42ad4b'
        ...
        voice_bars[4].style.background = '#42ad4b'
