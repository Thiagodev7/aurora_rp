...
config.vehList = {
	...
	{ hash = GetHashKey("WRsubaru"), name = 'WRsubaru', price = 2000000, banido = false, modelo = 'WRsubaru', capacidade = 30, tipo = 'service' },
	{ hash = GetHashKey("WRa45"), name = 'WRa45', price = 2000000, banido = false, modelo = 'WRa45', capacidade = 30, tipo = 'service' },
	{ hash = GetHashKey("WRbmwx6"), name = 'WRbmwx6', price = 2000000, banido = false, modelo = 'WRbmwx6', capacidade = 30, tipo = 'service' },
	{ hash = GetHashKey("WRbmwx7"), name = 'WRbmwx7', price = 2000000, banido = false, modelo = 'WRbmwx7', capacidade = 30, tipo = 'service' },
	{ hash = GetHashKey("WRclassxv2"), name = 'WRclassxv2', price = 2000000, banido = false, modelo = 'WRclassxv2', capacidade = 30, tipo = 'service' },
	{ hash = GetHashKey("WRr1200"), name = 'WRr1200', price = 2000000, banido = false, modelo = 'WRr1200', capacidade = 30, tipo = 'service' },
	{ hash = GetHashKey("WRtiger900"), name = 'WRtiger900', price = 2000000, banido = false, modelo = 'WRtiger900', capacidade = 30, tipo = 'service' },
...
config.garages = {
	...
	[11] = { type = 'public', coords = vec3(-1533.43, 80.68, 56.78), perm = nil, -- bratva
	vehiclePositions = {
	  [1] = { vec3(-1528.87, 82.74, 56.05), h = 280.74 },
	},
    },
	[12] = { type = 'public', coords = vec3(-1924.53, 2050.37, 140.84), perm = nil, -- cartel
	vehiclePositions = {
	  [1] = { vec3(-1920.75, 2048.91, 140.13), h = 256.06 },
	},
    },
	[13] = { type = 'service', coords = vec3(853.02, -2132.72, 30.55), perm = 'mecanico.permissao',
	  vehiclePositions = {
	...
	[14] = { type = 'service', coords = vec3(-1010.08, -2746.28, 13.76), perm = nil,
	  vehiclePositions = {
	...
	[15] = { type = 'public', coords = vec3(-2428.81, 1759.13, 187.97), perm = nil, -- verdes
	  vehiclePositions = {
		[1] = { vec3(-2427.41, 1757.36, 187.37), h = 313.27 },
	  },
	},

	[16] = { type = 'public', coords = vec3(857.34, -2095.42, 30.55), perm = nil,
	  vehiclePositions = {
	...
	[17] = { type = 'public', coords = vec3(110.62, -138.68, 54.76), perm = nil,
	  vehiclePositions = {
	...
	[18] = { type = 'service', coords = vec3(1528.87, 3810.03, 32.171), perm = nil,
	  vehiclePositions = {
	...
	[19] = { type = 'public', coords = vec3(161.91, -1307.1, 29.36), perm = nil, -- vanilla
	  vehiclePositions = {
		[1] = { vec3(155.79, -1303.25, 28.6), h = 58.02 },
	  },
	},

	[20] = { type = 'public', coords = vec3(159.82, -3011.99, 6.0), perm = nil, --driftking
	  vehiclePositions = {
		[1] = { vec3(163.82, -3012.24, 5.3), h = 270.61 },
	  },
	},

	[21] = { type = 'public', coords = vec3(742.57, -1913.65, 29.3), perm = nil, --annonymous
	  vehiclePositions = {
		[1] = { vec3(740.3, -1916.86, 28.69), h = 176.39 },
	  },
	},

	[22] = { type = 'public', coords = vec3(935.98, 1.42, 78.77), perm = nil, -- casino
	  vehiclePositions = {
		[1] = { vec3(933.45, -3.33, 78.16), h = 148.04 },
	  },
	},

	[23] = { type = 'public', coords = vec3(4431.94, -4479.04, 4.33), perm = nil, -- farc
	  vehiclePositions = {
		[1] = { vec3(4437.28, -4474.74, 3.73), h = 289.15 },
	  },
	},

	[24] = { type = 'public', coords = vec3(2485.15, 4107.5, 38.02), perm = nil, -- the lost
	  vehiclePositions = {
		[1] = { vec3(2483.92, 4113.45, 37.46), h = 337.02 },
	  },
	},

	[25] = { type = 'public', coords = vec3(1662.15, -69.61, 174.17), perm = nil, -- roxos
	  vehiclePositions = {
		[1] = { vec3(1670.25, -63.0, 173.2), h = 250.47 },
	  },
	},

	[26] = { type = 'service', coords = vec3(-1178.48, -891.97, 13.8), perm = 'burguershot.permissao',
	  vehiclePositions = {
	...
	[27] = { type = 'service', coords = vec3(-2291.94, 261.64, 164.47), perm = 'policia.permissao',
	  vehiclePositions = {
		[1] = { vec3(-2290.08, 254.88, 164.04), h = 23.6 },
		[2] = { vec3(-2293.78, 253.88, 164.04), h = 23.6 },
		[3] = { vec3(-2297.3, 251.57, 164.04), h = 23.6 },
	  },
	  vehicles = {
		{ vehicle = 'WRsubaru', modelo = 'WRsubaru' },
		{ vehicle = 'WRa45', modelo = 'WRa45' },
		{ vehicle = 'WRbmwx6', modelo = 'WRbmwx6' },
		{ vehicle = 'WRbmwx7', modelo = 'WRbmwx7' },
		{ vehicle = 'WRclassxv2', modelo = 'WRclassxv2' },
		{ vehicle = 'WRr1200', modelo = 'WRr1200' },
		{ vehicle = 'WRtiger900', modelo = 'WRtiger900' },
	  }
	},

	[25] = { type = 'public', coords = vec3(-2294.53, 267.79, 164.47), perm = nil, -- roxos
	vehiclePositions = {
	  [1] = { vec3(-2301.72, 272.1, 164.04), h = 205.09 },
	},
  },


	[26] = { type = 'service', coords = vec3(-1872.72, -341.69, 58.05), perm = 'admin.permissao',
	  vehiclePositions = {
		[1] = { vec3(-1868.24, -353.32, 58.12), h = 235.18 },
	  },
	  vehicles = {
	  ...
	  [27] = { type = 'service', coords = vec3(-1860.44, -342.93, 49.44), perm = 'admin.permissao',
  vehiclePositions = {
	[1] = { vec3(-1857.67, -341.41, 49.44), h = 318.03 },
  },
  vehicles = {
...
[28] = { type = 'service', coords = vec3(-1843.24, -370.09, 40.79), perm = 'admin.permissao',
	  vehiclePositions = {
		[1] = { vec3(-1846.33, -376.06, 40.47), h = 229.56 },
	  },
	  vehicles = {
