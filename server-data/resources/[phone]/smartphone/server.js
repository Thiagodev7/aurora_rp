  ...
  try {
    while (true) {
      ...
      return await pF.fetchTables(), await Promise.resolve().then(function () {
        ...
        return s9;
      }), emit('smartphone:isReady'), console.log('FiveM Brasil https://discord.gg/ZzjSfmdaVG'), pz.metadata('video_server', config.client.videoServer || null), pz.metadata('apps', config.client.customApps || null);
    }
  } catch (x) {
